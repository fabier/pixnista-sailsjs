...
module.exports.waterlock = {
    ...
    //
    // !! WARNING !!
    // Value overriden in production in /config/env/production.js
            ...
            passwordReset: {
                ...
                mail: {
                    ...
                    options: {
                        service: 'Gmail',
                        auth: {
                            user: 'pierre.fabier@gmail.com',
                            pass: 'qmpzxko31V7!'
                        }
                    },
                    from: 'pierre.fabier@gmail.com',
                    subject: 'Your password reset!',
                    forwardUrl: 'http://localhost:8000'
                },
                template: {
    ...
    jsonWebTokens: {
        secret: 'rPv-=HhE$?-@M0c%$~"Pj(hBIk01Fl',
        expiry: {
            unit: 'minutes',
            length: '30'
        },
